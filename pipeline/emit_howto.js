...
k.push(...titleBlock(
  'AP Cybersecurity · Teacher Onboarding',
  'How to Use This Course',
  'A concise workflow for running the AP Cybersecurity Teacher Superpack — what every file is, the daily rhythm, and how it all maps to your website.'
));

// ---------------------------------------------------------------- overview
k.push(h2('What this course is'));
k.push(p('A complete, College Board CED–aligned AP Cybersecurity course: 5 units, 24 lessons, each fully resourced with slide decks, fill-in guided notes, a teacher guide, and an assessment. Every Essential Knowledge statement in the CED is taught, and a running case scenario threads through each unit (1A→' +
