// Styling foundation for the AP Cybersecurity Unit 2 Teacher Superpack.
...
const C = {
  NAVY:'1E1B4B', PURPLE:'6B21A8', AMBER:'E8A020', AMBERTX:'8A5A00', AMBERBG:'FFF4DE',
  LAVBG:'EDE9FE', TEAL:'0F766E', TEALBG:'E6F4F1', LIGHT:'EDE9FE', CODEBG:'F4F2FB',
  GRAY:'555555', RULE:'6B21A8'
};
...
function brandHeader(docLabel,unitLabel){return new Header({children:[new Paragraph({
  ...
  children:[new TextRun({text:'AP Cybersecurity \u2022 '+(unitLabel||'Unit 2: Securing Spaces'),bold:true,size:16,color:C.NAVY}),
